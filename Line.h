...
Line::Line(int xS, int yS, int xE, int yE) : start(xS, yS), end(xE, yE) {}
...
void Line::MidPoint(int xS, int yS, int xE, int yE)
{                                                                                                                                  //0 50 50 0
    int a = yS - yE, b = xE - xS, c = xS * yE - xE * yS;                                                                           //直线方程 50 50 -250
    int u = a * b > 0 ? 0 : 1;                                                                                                     //斜率大于0时u=1，反之=0
    ...
    {
        delta0 = u == 1 ? b + b + a : -b - b + a, delta1 = u == 1 ? b + b + a + a : -b - b, delta2 = u == 1 ? b + b : -b - b + a + a;
        int d = u == 1 ? 1 : -1;
        while (abs(y - yE) > 0)
        {
            if (delta0 < 0)
